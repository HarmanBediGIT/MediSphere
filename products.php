...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <?php
            ...
            ?>
                <div class="login-container" style="display:flex; max-width:100%; margin-bottom:0px;">
                    <div class="login-container">
                        <button type="submit" class="category-btn" id="openModalBtn">Add New Product</button>
                        <button type="button" class="category-btn" id="bulkUploadBtn">Bulk Upload Products</button>
                        <input type="file" id="csvFileInput" name="csv_file" accept=".csv" style="display: none;">
                    </div>

                    <div class="login-container">
                        <button type="button" class="category-btn" style="width:10%; margin-left:400px;" id="downloadCSV"><i class="fas fa-download"></i></button>
                    </div>
                </div>
        <?php } ?>
                        ...
                        echo '<div class="product-card">';
                            ...
                            echo '<div class="product-info">';
                                ...
                                echo '<div class="product-actions">';
                                    echo '<button class="product-button" onclick="window.location.href=\'detailed_products.php?prod_code=' . $row["prod_code"] . '\'">View Details</button>';
            ...
            <div class="modal-content">
                ...
                <form id="categoryForm">
                    <div class="form-group">
                        ...
                        <input type="text" id="cat_code" name="cat_code" placeholder="eg: CAT001" required>
                    </div>
                    <div class="form-group">
                        <label for="prod_code">Product Code :</label>
                        <input type="text" id="prod_code" name="prod_code" placeholder="eg: PRD001" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="colors" name="colors" placeholder="eg: Red, Blue, White">
                    </div>
                    <div class="form-group">
                        <label for="sizes">Sizes :</label>
                        <input type="text" id="sizes" name="sizes" placeholder="eg: S, M, L, XL">
                    </div>
                    <div class="form-group">
                        <label for="material">Material :</label>
                        <input type="text" id="material" name="material" placeholder="eg: Latex, Plastic, Metal">
                    </div>
                    <div class="form-group">
                        <label for="manufacturer">Manufacturer :</label>
                        <input type="text" id="manufacturer" name="manufacturer" placeholder="eg: MedTech Corp">
                    </div>
                    <div class="form-group">
