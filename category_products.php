<?php
    ...
    // Get the category code from the URL
    $categoryCode = isset($_GET['code']) ? $conn->real_escape_string($_GET['code']) : '';
    ...
    $categoryQuery = "SELECT * FROM categories WHERE code = '$categoryCode'";
    ...
    $productQuery = "SELECT * FROM products WHERE cat_code = '$categoryCode'";
    $productResult = $conn->query($productQuery);

    $category_id = $_GET['category_id'] ?? null;
// Use this ID to fetch and display all products in that category
...
?>
    ...
    <html lang="en" dir="ltr">
        ...
        <body>
            ...
            <?php
                echo " <br> <h1 style='text-align:center'>Products in " . htmlspecialchars($category['name']) . " : " . "</h1> <br>";
