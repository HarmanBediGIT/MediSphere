            ...
            <div class="container">
                ...
                <div class="product-list">
                    <div class="product-item">
                        <img src="images/" alt="Digital Thermometer">
                        <h3>Digital Thermometer 1</h3>
                        <p class="price">$49</p>
                        <a href="#" class="add-to-cart-button" 
                        data-product-name="Digital Thermometer 1" 
                        data-product-price="49">Add to Cart</a>
                    </div>
                    <div class="product-item">
                        <img src="images/" alt="Surgical Gloves">
                        <h3>Surgical Gloves</h3>
                        <p class="price">$14</p>
                        <a href="#" class="add-to-cart-button" 
                        data-product-name="Surgical Gloves" 
                        data-product-price="14">Add to Cart</a>
                    </div>
                    <div class="product-item">
                        <img src="images/" alt="Infrared Thermometer">
                        <h3>Infrared Thermometer</h3>
                        <p class="price">$10</p>
                        <a href="#" class="add-to-cart-button" 
                        data-product-name="Infrared Thermometer" 
                        data-product-price="10">Add to Cart</a>
                    </div>
                    <div class="product-item">
                        <img src="images/" alt="Pulse Oximeter">
                        <h3>Pulse Oximeter</h3>
                        <p class="price">$181</p>
                        <a href="#" class="add-to-cart-button" 
                        data-product-name="Pulse Oxymeter" 
                        data-product-price="181">Add to Cart</a>
                    </div>
                </div>
            </div>
        </section>
